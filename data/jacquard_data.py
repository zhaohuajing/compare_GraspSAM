...
# grep "crop_size":
# ./data/load_dataset.py:        train_dataset = JacquardDataset(root=root, crop_size=1024, include_mask=True, start=0.0, end=0.9)
# ./data/load_dataset.py:        test_dataset = JacquardDataset(root=root, crop_size=1024, include_mask=True, start=0.9, end=1.0)
# ./data/load_data.py:        train_dataset = JacquardDataset(root=root, crop_size=1024, include_mask=True, 
# ./data/load_data.py:        test_dataset = JacquardDataset(root=root, crop_size=1024, include_mask=True, 
# ./data/grasp_anything_data.py:        # gtbbs.resize(self.crop_size, self.output_size)
# ./data/base_grasp_data.py:    def __init__(self, output_size=1024, crop_size=224, include_depth=False, include_mask=False, include_rgb=True,
# ./data/base_grasp_data.py:        self.crop_size = crop_size
# ./data/base_grasp_data.py:            pos_img, ang_img, width_img = bbs.draw((self.crop_size, self.crop_size))
